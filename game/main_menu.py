...
from snake_arena import snake_arena_game
from utils.constants import SCREEN_WIDTH, WHITE, YELLOW
...
def main_menu(screen):
    ...
    while True:
        ...
        controls_text = pygame.font.Font(None, 30).render(
            "Use LEFT/RIGHT arrows to change", 1, YELLOW
        )
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_UP:
                    ...
                    if selected_option == 0:
                        ...
                        snake_arena_game(screen, num_players)
                    else:
                        pygame.quit()
                        sys.exit()
